            ...
            with torch.no_grad():
                ...
                for model, filename in models_to_evaluate:
                    ...
                    for i in range(10):
                        ...
                        # PEDIATRIC BENCHMARK -- the ONLY edit in this file.
                        # Upstream hardcodes the 18 CT-RATE pathologies here. That is
                        # an in-training DIAGNOSTIC readout only; it does not touch the
                        # contrastive objective, the optimizer or the weights. With a
                        # 23-class cohort it crashed at step 0 in f1_score with
                        # "Multi-label binary indicator input with different numbers of
                        # labels". Made overridable; with no override the original
                        # 18-class list is used, so upstream behaviour is unchanged.
                        pathologies = getattr(self, 'pathologies_override', None) or ['Medical material','Arterial wall calcification', 'Cardiomegaly', 'Pericardial effusion','Coronary artery wall calcification', 'Hiatal hernia','Lymphadenopathy', 'Emphysema', 'Atelectasis', 'Lung nodule','Lung opacity', 'Pulmonary fibrotic sequela', 'Pleural effusion', 'Mosaic attenuation pattern','Peribronchial thickening', 'Consolidation', 'Bronchiectasis','Interlobular septal thickening']
