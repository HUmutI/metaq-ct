...
class CTCLIP(nn.Module):
    ...
    def forward(
        ...
        freeze_text_encoder = True,    # text encoder is not trained if this is set to True
        ...
        text_embeddings = model_forward_with_context(
            fn = self.text_transformer,
            args = (text.input_ids, text.attention_mask),
